const containerStyles = '.snackbar{opacity:0;position:fixed;z-index:3;bottom:0;left:0;\
...
const messageStyles = '.snackbar .message{flex:1;color:white;margin:0 48px 0 0}';

const buttonStyles = '.snackbut{margin:0 24px 0 0;float:right;color:tomato;\
